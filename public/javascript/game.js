    ...
    interact('.draggable').draggable({
        ...
        listeners: {
            start: function (event) {
                ...
                $(event.target.parentElement).prepend($(event.target.outerHTML).css({position: 'absolute', top: rect.top, left: rect.left}).attr('id', 'kill').removeClass('draggable'));
                console.log($('#kill').css('top'));
            },
